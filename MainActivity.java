...
public class MainActivity extends AppCompatActivity {
	...
	private LinearLayout main_body_upload;
	private LinearLayout box_upload_header;
	private LinearLayout box_regular_2;
	private LinearLayout box_amoled_2;
	private LinearLayout box_logs_2;
	private LinearLayout box_information;
	private LinearLayout box_exit;
	private TextView header_upload_title;
	private TextView header_regular;
	private LinearLayout box_regular_1;
	private LinearLayout box_regular_3;
	private LinearLayout box_regular_6;
	private EditText edit_regular_1;
	private EditText edit_regular_3;
	private LinearLayout box_regular_4;
	private LinearLayout box_regular_5;
	private TextView regular_submit;
	private TextView regular_delete;
	private TextView header_amoled;
	private LinearLayout box_amoled_1;
	private LinearLayout box_amoled_3;
	private LinearLayout box_amoled_6;
	private EditText edit_amoled_1;
	private EditText edit_amoled_3;
	private LinearLayout box_amoled_4;
	private LinearLayout box_amoled_5;
	private TextView amoled_submit;
	private TextView amoled_delete;
	private TextView header_logs;
	private LinearLayout box_logs_1;
	private LinearLayout box_logs_3;
	private EditText edit_logs_1;
	private LinearLayout box_logs_4;
	private LinearLayout box_logs_5;
	private TextView logs_save;
	private TextView logs_edit;
	private TextView title_format;
	private TextView body_format;
	private TextView title_delete;
	private TextView body_delete;
	private TextView title_exit;
	private ScrollView main_body_scroll;
	...
	private DatabaseReference regular_mod_data = _firebase.getReference("regular_mod_data");
	private ChildEventListener _regular_mod_data_child_listener;
	private DatabaseReference amoled_black_data = _firebase.getReference("amoled_black_data");
	private ChildEventListener _amoled_black_data_child_listener;
	...
	private AlertDialog.Builder Developer_Login;
	private DatabaseReference Developer = _firebase.getReference("Developer");
	private ChildEventListener _Developer_child_listener;
	...
	private AlertDialog.Builder Developer_Logout;
	...
	private SharedPreferences DEVELOPER_MODE;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		main_body_intro = (LinearLayout) findViewById(R.id.main_body_intro);
		main_scroll_about = (ScrollView) findViewById(R.id.main_scroll_about);
		main_scroll_upload = (ScrollView) findViewById(R.id.main_scroll_upload);
		...
		box_uploader = (LinearLayout) findViewById(R.id.box_uploader);
		box_update = (LinearLayout) findViewById(R.id.box_update);
		icon_uploader = (ImageView) findViewById(R.id.icon_uploader);
		icon_update = (ImageView) findViewById(R.id.icon_update);
		hidden_download = (TextView) findViewById(R.id.hidden_download);
		dev_1 = (TextView) findViewById(R.id.dev_1);
		dev_2 = (TextView) findViewById(R.id.dev_2);
		...
		main_body_upload = (LinearLayout) findViewById(R.id.main_body_upload);
		box_upload_header = (LinearLayout) findViewById(R.id.box_upload_header);
		box_regular_2 = (LinearLayout) findViewById(R.id.box_regular_2);
		box_amoled_2 = (LinearLayout) findViewById(R.id.box_amoled_2);
		box_logs_2 = (LinearLayout) findViewById(R.id.box_logs_2);
		box_information = (LinearLayout) findViewById(R.id.box_information);
		box_exit = (LinearLayout) findViewById(R.id.box_exit);
		header_upload_title = (TextView) findViewById(R.id.header_upload_title);
		header_regular = (TextView) findViewById(R.id.header_regular);
		box_regular_1 = (LinearLayout) findViewById(R.id.box_regular_1);
		box_regular_3 = (LinearLayout) findViewById(R.id.box_regular_3);
		box_regular_6 = (LinearLayout) findViewById(R.id.box_regular_6);
		edit_regular_1 = (EditText) findViewById(R.id.edit_regular_1);
		edit_regular_3 = (EditText) findViewById(R.id.edit_regular_3);
		box_regular_4 = (LinearLayout) findViewById(R.id.box_regular_4);
		box_regular_5 = (LinearLayout) findViewById(R.id.box_regular_5);
		regular_submit = (TextView) findViewById(R.id.regular_submit);
		regular_delete = (TextView) findViewById(R.id.regular_delete);
		header_amoled = (TextView) findViewById(R.id.header_amoled);
		box_amoled_1 = (LinearLayout) findViewById(R.id.box_amoled_1);
		box_amoled_3 = (LinearLayout) findViewById(R.id.box_amoled_3);
		box_amoled_6 = (LinearLayout) findViewById(R.id.box_amoled_6);
		edit_amoled_1 = (EditText) findViewById(R.id.edit_amoled_1);
		edit_amoled_3 = (EditText) findViewById(R.id.edit_amoled_3);
		box_amoled_4 = (LinearLayout) findViewById(R.id.box_amoled_4);
		box_amoled_5 = (LinearLayout) findViewById(R.id.box_amoled_5);
		amoled_submit = (TextView) findViewById(R.id.amoled_submit);
		amoled_delete = (TextView) findViewById(R.id.amoled_delete);
		header_logs = (TextView) findViewById(R.id.header_logs);
		box_logs_1 = (LinearLayout) findViewById(R.id.box_logs_1);
		box_logs_3 = (LinearLayout) findViewById(R.id.box_logs_3);
		edit_logs_1 = (EditText) findViewById(R.id.edit_logs_1);
		box_logs_4 = (LinearLayout) findViewById(R.id.box_logs_4);
		box_logs_5 = (LinearLayout) findViewById(R.id.box_logs_5);
		logs_save = (TextView) findViewById(R.id.logs_save);
		logs_edit = (TextView) findViewById(R.id.logs_edit);
		title_format = (TextView) findViewById(R.id.title_format);
		body_format = (TextView) findViewById(R.id.body_format);
		title_delete = (TextView) findViewById(R.id.title_delete);
		body_delete = (TextView) findViewById(R.id.body_delete);
		title_exit = (TextView) findViewById(R.id.title_exit);
		main_body_scroll = (ScrollView) findViewById(R.id.main_body_scroll);
		...
		changelogs_0 = (TextView) findViewById(R.id.changelogs_0);
		...
		Developer_Login = new AlertDialog.Builder(this);
		Developer_Logout = new AlertDialog.Builder(this);
		DEVELOPER_MODE = getSharedPreferences("DEVELOPER_MODE", Activity.MODE_PRIVATE);
		
		box_uploader.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				try {
					_RequiredDialog(Developer_Login, false);
					Developer_Login.setTitle("DEVELOPER MODE");
					final EditText edit_dev = new EditText(MainActivity.this);
					...
					edit_dev.setLayoutParams(lpar);
					
					edit_dev.setHint("What's the password?");
					edit_dev.setHintTextColor(Color.parseColor("#FF9E9E9E"));
					edit_dev.setTextColor(Color.parseColor("#FFFFFFFF"));
					
					Developer_Login.setView(edit_dev);
					Developer_Login.setPositiveButton("LOGIN", new DialogInterface.OnClickListener() {
						@Override
						public void onClick(DialogInterface _dialog, int _which) {
							_RequiredDialog(Developer_Login, true);
							dev_1.setText(edit_dev.getText());
							if (dev_1.getText().toString().equals(dev_2.getText().toString())) {
								final ProgressDialog prog = new ProgressDialog(MainActivity.this, ProgressDialog.THEME_DEVICE_DEFAULT_DARK);prog.setMax(100);prog.setMessage("Please wait...");prog.setIndeterminate(true) ;prog.setCancelable(false);if (!MainActivity.this.isFinishing()){ prog.show(); }
								Timer = new TimerTask() {
									@Override
									public void run() {
										runOnUiThread(new Runnable() {
											...
											public void run() {
												...
												main_scroll_upload.setVisibility(View.VISIBLE);
												main_body_intro.setVisibility(View.GONE);
												main_refresh_layout.setVisibility(View.GONE);
												main_scroll_about.setVisibility(View.GONE);
												box_uploader.setEnabled(false);
												box_update.setEnabled(false);
												prog.dismiss();
											}
										});
									}
							...
							edit_dev.setEnabled(false);
						}
					});
					Developer_Login.setNeutralButton("CANCEL", new DialogInterface.OnClickListener() {
						@Override
						public void onClick(DialogInterface _dialog, int _which) {
							_RequiredDialog(Developer_Login, true);
							edit_dev.setEnabled(false);
		...
		box_icon_close.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				main_scroll_about.setVisibility(View.GONE);
				main_scroll_upload.setVisibility(View.GONE);
				main_body_intro.setVisibility(View.GONE);
			}
		});
		
		box_exit.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				try {
					_RequiredDialog(Developer_Logout, false);
					Developer_Logout.setTitle("DEVELOPER MODE");
					Developer_Logout.setPositiveButton("LOG OUT", new DialogInterface.OnClickListener() {
						@Override
						public void onClick(DialogInterface _dialog, int _which) {
							_RequiredDialog(Developer_Logout, true);
							final ProgressDialog prog = new ProgressDialog(MainActivity.this, ProgressDialog.THEME_DEVICE_DEFAULT_DARK);prog.setMax(100);prog.setMessage("Refreshing databases...");prog.setIndeterminate(true) ;prog.setCancelable(false);if (!MainActivity.this.isFinishing()){ prog.show(); }
							main_body.setEnabled(false);
							main_body.setAlpha((float)(0.65d));
							regular_mod_data.addListenerForSingleValueEvent(new ValueEventListener() {
								@Override
								public void onDataChange(DataSnapshot _dataSnapshot) {
									listdata = new ArrayList<>();
									try {
							...
							amoled_black_data.addListenerForSingleValueEvent(new ValueEventListener() {
								@Override
								public void onDataChange(DataSnapshot _dataSnapshot) {
									listdata = new ArrayList<>();
									try {
							...
							Developer.addListenerForSingleValueEvent(new ValueEventListener() {
								@Override
								public void onDataChange(DataSnapshot _dataSnapshot) {
									others = new ArrayList<>();
									try {
									...
									Developer.addChildEventListener(_Developer_child_listener);
								}
								@Override
								public void onCancelled(DatabaseError _databaseError) {
								}
								...
								public void run() {
									runOnUiThread(new Runnable() {
										...
										public void run() {
											...
											main_refresh_layout.setVisibility(View.VISIBLE);
											main_scroll_about.setVisibility(View.GONE);
											box_uploader.setEnabled(true);
											box_update.setEnabled(true);
											prog.dismiss();
										}
									});
								}
							...
							_timer.schedule(Timer, (int)(100));
							DEVELOPER_MODE.edit().putString("DEVELOPER", "OFF").commit();
							Connection.startRequestNetwork(RequestNetworkController.GET, "https://spotify.com", "PAWN!", _Connection_request_listener);
						}
					});
					Developer_Logout.setNeutralButton("CANCEL", new DialogInterface.OnClickListener() {
						@Override
						public void onClick(DialogInterface _dialog, int _which) {
							_RequiredDialog(Developer_Logout, true);
						}
					});
					Developer_Logout.create().show();
				}
				catch(Exception e) {
				}
			}
		...
		edit_regular_1.addTextChangedListener(new TextWatcher() {
			@Override
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				final String _charSeq = _param1.toString();
				Regular_Title = _charSeq;
				_Locked();
			}
		...
		edit_regular_3.addTextChangedListener(new TextWatcher() {
			@Override
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				final String _charSeq = _param1.toString();
				Regular_Link = _charSeq;
				_Locked();
			}
		...
		box_regular_4.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				try {
					vmap_data = new HashMap<>();
					vmap_data.put("title", edit_regular_1.getText().toString().replace(".", "-"));
					vmap_data.put("link", edit_regular_3.getText().toString());
					regular_mod_data.child(edit_regular_1.getText().toString().replace(".", "-")).updateChildren(vmap_data);
					vmap_data.clear();
					edit_regular_1.setText("");
					edit_regular_3.setText("");
		...
		box_regular_5.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				try {
					regular_mod_data.child(edit_regular_1.getText().toString().replace(".", "-")).removeValue();
					vmap_data.remove(edit_regular_1.getText().toString().replace(".", "-"));
					edit_regular_1.setText("");
					edit_regular_3.setText("");
		...
		edit_amoled_1.addTextChangedListener(new TextWatcher() {
			@Override
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				final String _charSeq = _param1.toString();
				Amoled_Title = _charSeq;
				_Locked();
			}
		...
		edit_amoled_3.addTextChangedListener(new TextWatcher() {
			@Override
			public void onTextChanged(CharSequence _param1, int _param2, int _param3, int _param4) {
				final String _charSeq = _param1.toString();
				Amoled_Link = _charSeq;
				_Locked();
			}
		...
		box_amoled_4.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				try {
					vmap_data = new HashMap<>();
					vmap_data.put("title", edit_amoled_1.getText().toString().replace(".", "-"));
					vmap_data.put("link", edit_amoled_3.getText().toString());
					amoled_black_data.child(edit_amoled_1.getText().toString().replace(".", "-")).updateChildren(vmap_data);
					vmap_data.clear();
					edit_amoled_1.setText("");
					edit_amoled_3.setText("");
					SketchwareUtil.showMessage(getApplicationContext(), "Successfully added");
		...
		box_amoled_5.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				try {
					amoled_black_data.child(edit_amoled_1.getText().toString().replace(".", "-")).removeValue();
					vmap_data.remove(edit_amoled_1.getText().toString().replace(".", "-"));
					edit_amoled_1.setText("");
					edit_amoled_3.setText("");
					SketchwareUtil.showMessage(getApplicationContext(), "Successfully deleted");
		...
		box_logs_4.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				try {
					final ProgressDialog prog = new ProgressDialog(MainActivity.this, ProgressDialog.THEME_DEVICE_DEFAULT_DARK);prog.setMax(100);prog.setMessage("Saving changes...");prog.setIndeterminate(true) ;prog.setCancelable(false);if (!MainActivity.this.isFinishing()){ prog.show(); }
					vmap_data.put("Changelogs", edit_logs_1.getText().toString());
					Mod_Changelogs.child("Mod_Changelogs").updateChildren(vmap_data);
					edit_logs_1.setTextColor(0xFF9E9E9E);
					logs_save.setTextColor(0xFF9E9E9E);
					logs_edit.setTextColor(0xFFFFFFFF);
					edit_logs_1.setEnabled(false);
					box_logs_4.setEnabled(false);
					box_logs_5.setEnabled(true);
					Timer = new TimerTask() {
						@Override
						public void run() {
							runOnUiThread(new Runnable() {
								...
								public void run() {
									prog.dismiss();
									SketchwareUtil.showMessage(getApplicationContext(), "Successfully edited");
								}
							});
						}
					};
		...
		box_logs_5.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				edit_logs_1.setTextColor(0xFF000000);
				logs_save.setTextColor(0xFFFFFFFF);
				logs_edit.setTextColor(0xFF9E9E9E);
				edit_logs_1.setEnabled(true);
				box_logs_4.setEnabled(true);
				box_logs_5.setEnabled(false);
				SketchwareUtil.showMessage(getApplicationContext(), "Edit mode activated");
			}
		});
					...
					Clear_Cache.setPositiveButton("CONTINUE", new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface _dialog, int _which) {
							...
							if (FileUtil.isExistFile("/storage/emulated/0/Android/data/com.spotify.music/")) {
								...
								_timer.schedule(Timer, (int)(100));
								SketchwareUtil.showMessage(getApplicationContext(), "Directory files already cleared");
							}
						}
					});
		...
		_regular_mod_data_child_listener = new ChildEventListener() {
			@Override
		...
		regular_mod_data.addChildEventListener(_regular_mod_data_child_listener);
		
		_amoled_black_data_child_listener = new ChildEventListener() {
			@Override
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				GenericTypeIndicator<HashMap<String, Object>> _ind = new GenericTypeIndicator<HashMap<String, Object>>() {};
				final String _childKey = _param1.getKey();
		...
		amoled_black_data.addChildEventListener(_amoled_black_data_child_listener);
		...
		_Developer_child_listener = new ChildEventListener() {
			@Override
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				GenericTypeIndicator<HashMap<String, Object>> _ind = new GenericTypeIndicator<HashMap<String, Object>>() {};
				final String _childKey = _param1.getKey();
				final HashMap<String, Object> _childValue = _param1.getValue(_ind);
				dev_2.setText(_childValue.get("Add_Datas").toString());
			}
		...
		_Mod_Changelogs_child_listener = new ChildEventListener() {
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				final String _childKey = _param1.getKey();
				final HashMap<String, Object> _childValue = _param1.getValue(_ind);
				changelogs_0.setText(_childValue.get("Changelogs").toString());
				edit_logs_1.setText(_childValue.get("Changelogs").toString());
			}
									...
									if (cursor.getInt(cursor.getColumnIndex(DownloadManager.COLUMN_STATUS)) == DownloadManager.STATUS_FAILED) {
										...
										runOnUiThread(new Runnable() {
											public void run() { 
												...
												showMessage("The file or link is currently unavailable. Please try again later.");
											}
										});
										prog.cancel();
										break;
	...
	private void _Model_UI () {
		...
		changelogs_0.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/base_font.ttf"), 1);
		...
		title_format.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/base_font.ttf"), 1);
		body_format.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/base_font.ttf"), 1);
		title_exit.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/base_font.ttf"), 1);
		body_delete.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/base_font.ttf"), 1);
		title_delete.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/base_font.ttf"), 1);
		regular_delete.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/base_font.ttf"), 1);
		amoled_delete.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/base_font.ttf"), 1);
		header_logs.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/base_font.ttf"), 1);
		logs_save.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/base_font.ttf"), 1);
		logs_edit.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/base_font.ttf"), 1);
		header_upload_title.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/base_font.ttf"), 1);
		...
		header_regular.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/base_font.ttf"), 1);
		regular_submit.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/base_font.ttf"), 1);
		header_amoled.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/base_font.ttf"), 1);
		amoled_submit.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/base_font.ttf"), 1);
		if (!ON_SCREEN.getString("ON_SCREEN", "").equals("ON_SCREEN")) {
			try {
				...
				box_uploader.setVisibility(View.GONE);
		...
		if (DEVELOPER_MODE.getString("DEVELOPER", "").equals("OFF")) {
			main_body_intro.setVisibility(View.GONE);
			main_scroll_about.setVisibility(View.GONE);
			main_scroll_upload.setVisibility(View.GONE);
			main_refresh_layout.setVisibility(View.VISIBLE);
			...
			if (DEVELOPER_MODE.getString("DEVELOPER", "").equals("ON")) {
				main_body_intro.setVisibility(View.GONE);
				main_scroll_about.setVisibility(View.GONE);
				main_scroll_upload.setVisibility(View.VISIBLE);
				main_refresh_layout.setVisibility(View.GONE);
		...
		regular_submit.setTextColor(0xFF9E9E9E);
		regular_delete.setTextColor(0xFF9E9E9E);
		amoled_submit.setTextColor(0xFF9E9E9E);
		amoled_delete.setTextColor(0xFF9E9E9E);
		edit_logs_1.setTextColor(0xFF9E9E9E);
		logs_save.setTextColor(0xFF9E9E9E);
		box_regular_4.setEnabled(false);
		box_regular_5.setEnabled(false);
		box_amoled_4.setEnabled(false);
		box_amoled_5.setEnabled(false);
		edit_logs_1.setEnabled(false);
		logs_save.setEnabled(false);
	...
	private void _Locked () {
		if (!(Regular_Title.equals("") || Regular_Link.equals(""))) {
			Lock_Check = true;
		}
		else {
			Lock_Check = false;
		...
		if (Lock_Check) {
			box_regular_4.setEnabled(true);
			regular_submit.setTextColor(0xFFFFFFFF);
		}
		else {
			box_regular_4.setEnabled(false);
			regular_submit.setTextColor(0xFF9E9E9E);
		}
		if (!Regular_Title.equals("")) {
			Lock_Check = true;
		}
		else {
			Lock_Check = false;
		...
		if (Lock_Check) {
			box_regular_5.setEnabled(true);
			regular_delete.setTextColor(0xFFFFFFFF);
		}
		else {
			box_regular_5.setEnabled(false);
			regular_delete.setTextColor(0xFF9E9E9E);
		}
		if (!(Amoled_Title.equals("") || Amoled_Link.equals(""))) {
			Lock_Check = true;
		}
		else {
			Lock_Check = false;
		...
		if (Lock_Check) {
			box_amoled_4.setEnabled(true);
			amoled_submit.setTextColor(0xFFFFFFFF);
		}
		else {
			box_amoled_4.setEnabled(false);
			amoled_submit.setTextColor(0xFF9E9E9E);
		}
		if (!Amoled_Title.equals("")) {
			Lock_Check = true;
		}
		else {
			Lock_Check = false;
		...
		if (Lock_Check) {
			box_amoled_5.setEnabled(true);
			amoled_delete.setTextColor(0xFFFFFFFF);
		}
		else {
			box_amoled_5.setEnabled(false);
			amoled_delete.setTextColor(0xFF9E9E9E);
